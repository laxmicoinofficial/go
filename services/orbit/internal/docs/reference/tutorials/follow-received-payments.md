...
using JavaScript and `EventSource`.  We will eschew using [`js-rover-sdk`](https://github.com/laxmicoinofficial/js-rover-sdk), the
...
> If you need a reliable streaming connection please use our [SDK](https://github.com/laxmicoinofficial/js-rover-sdk).
