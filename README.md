...
[![GoDoc](https://godoc.org/github.com/laxmicoinofficial/go?status.svg)](https://godoc.org/github.com/laxmicoinofficial/go)
[![Go Report Card](https://goreportcard.com/badge/github.com/laxmicoinofficial/go)](https://goreportcard.com/report/github.com/laxmicoinofficial/go)

This repo is the home for all of the public go code.  In addition to various tools and services, this repository is the SDK from which you may develop your own applications that integrate with the rover network.
...
You can use Glide yourself in your project and add rover go as a vendor'd dependency, or you can just drop this repos as `$GOPATH/src/github.com/laxmicoinofficial/go` to import it the canonical way (you still need to run `glide install`).
...
In addition to the packages described above, this repository contains various packages related to working with the Rover network from a go program.  It's recommended that you use [godoc](https://godoc.org/github.com/laxmicoinofficial/go#pkg-subdirectories) to browse the documentation for each.
